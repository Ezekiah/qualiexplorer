...
BASE_URL = '/qualiexplorer/'
LOGIN_REDIRECT_URL = BASE_URL
LOGIN_URL = '/qualiexplorer/?p=access&q=login'
...
HAYSTACK_SITECONF = 'qualiexplorer.search_sites'
...
HAYSTACK_SOLR_URL = 'http://vaughan.dime-shs.sciences-po.fr:'+str(SOLR_PORT)+'/solr/qualiexplorer'
HAYSTACK_SOLR_TIMEOUT = 60 * 5

HAYSTACK_CONNECTIONS = {
    'default': {
        'ENGINE': 'haystack.backends.solr_backend.SolrEngine',
        'URL': 'http://vaughan.dime-shs.sciences-po.fr:'+str(SOLR_PORT)+'/solr/qualiexplorer'
        # ...or for multicore...
...
DATABASES = {
	'default': {
		...
		'HOST': 'vaughan.dime-shs.sciences-po.fr',  					# Set to empty string for localhost. Not used with sqlite3.
...
STATIC_URL = '/qualiexplorer/static/'
...
ADMIN_MEDIA_PREFIX = '/qualiexplorer/media/admin/'
...
ROOT_URLCONF = 'qualiexplorer.urls'

...
class Texte(models.Model):
	...
	doccat2 = models.CharField(max_length=255)	# see globalvars.py
	name = models.CharField(max_length=255)
	description = models.TextField( blank=True, default="")
	# todo
	date = models.DateField(default=datetime.datetime.today())	# "2011-01-02"
	location = models.CharField(max_length=255) 					# "Paris" todo: change to gps specific field ?
	locationgeo = models.CharField(max_length=255,  blank=True, null=True)
...
class AttributeType(models.Model):
	enquete = models.ForeignKey(Enquete)
	name = models.CharField(max_length=255)
	publicy = models.CharField(max_length=255, choices=ATTRIBUTE_PUBLICY_CHOICES)
	def __unicode__(self):
		return self.name
##############################################################################	
...
class Speaker(models.Model):
	...
	ddi_id = models.CharField(max_length=255)
	## USED TO KNOW (investigator/speaker/protagonist)
	ddi_type = models.CharField(max_length=255, choices=SPEAKER_TYPE_CHOICES)
	#################
	public = models.BooleanField(default=False)					# visible in esbrowse or not
	attributes = models.ManyToManyField(Attribute)
	color = models.CharField(max_length=255,default=HTML_COLORS[0])
...
class WordEntity(models.Model):
	...
	textes = models.ManyToManyField(Texte)
	######
	content = models.CharField(max_length=255) 			# word content
